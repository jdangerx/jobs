...
\begin{center}
  ...
  1660 Madison Ave 8G,
  New York, NY 10029\\
  (650)283-6856 $\lozenge$ djx@uchicago.edu
\end{center}
\textbf{EDUCATION} \\
...
\noindent\textbf{Recurse Center}, New York, NY \\
\textbf{Participant}, August 2015 - November 2015
\begin{tightlist}

  \item Completed architecture course which went from logic gates to
...
\begin{tightlist}
  ...
  \item Wrote a framework to run geospatial analytic scripts with
  Hadoop and Spark

  \item Maintained single-node installations of Hadoop and Spark on
  virtual machines

  \item Shared analytic results by integrating above framework with
  Django, PostGIS, and GeoServer
